...
class Menu:
    def __init__(self, screen):
        ...
        self.main_toolbars[0].add_button('layers', lambda: self.select_toolbar(4), (176, 0), (33, 20))
        ...
        self.other_toolbars[-1].add_button('perpendicular',
                                           ...
                                           (200, 30), self.font.render('Перпендикуляр', False, (0, 0, 0)), (30, 7))
        self.other_toolbars[-1].add_button('parallel',
                                           lambda: self.screen.plot.create_parallel(False), (5, 27),
                                           (200, 30), self.font.render('Параллельно', False, (0, 0, 0)), (30, 7))
        ...
        self.other_toolbars[-1].add_button('horizontal',
                                           ...
                                           (200, 30), self.font.render('Горизонталь', False, (0, 0, 0)), (30, 7))
        self.other_toolbars[-1].add_button('frontal',
                                           lambda: self.screen.plot.create_h_f(f=True), (5, 81),
                                           (200, 30), self.font.render('Фронталь', False, (0, 0, 0)), (30, 7))
        ...
        self.other_toolbars[-1].add_button('3points',
                                           ...
                                           (200, 30), self.font.render('3 точки', False, (0, 0, 0)), (30, 7))
        self.other_toolbars[-1].add_button('parallel',
                                           lambda: self.screen.plot.create_parallel_plane(), (5, 27),
                                           (200, 30), self.font.render('Параллельно', False, (0, 0, 0)), (30, 7))

        self.other_toolbars.append(Toolbar2(self.screen, (5, 60), (220, 70)))
    ...
    def update_layer_list(self):
        ...
        # TODO: добавить возможность включать/выключать слой, на переключаясь на него
        ...
        self.other_toolbars[3].add_button(
            ...
            text=self.font.render(self.screen.plot.layers[i].name, False, (0, 0, 0)), text_pos=(5, 7))
        i += 1
